-- ============================================================
-- Atomic checkout v5: store discount totals + applied-discount log
-- on each order. The discount engine runs on the client (it has all
-- the cart + product context and the current kzt rate), and the RPC
-- just records what was applied so the invoice / PDF can reproduce it.
-- Run AFTER discounts.sql.
-- ============================================================

ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS discount_kzt numeric(12, 2) NOT NULL DEFAULT 0,
